...
public final class FindMeetingQueryTest {
  ...
  public void optionalAttendeeCannotAttend() {
    // Have each person have different events with optional attendee having an all day event.
    // We should see three options because there are no available time slots for optional attendee, 
    // but the other two people split the times.
    //
    // Events  :       |--A--|     |--B--|
    //           |--------------C--------------|
    // Day     : |-----------------------------|
  ...
  public void optionalAttendeeCanAttend() {
    // Have each person have different events. We should see two options that split the times
    // so optional attendee can attend.
    //
    // Events  :       |--A--|     |--B--|
    //                       |--C--|
    // Day     : |-----------------------------|
